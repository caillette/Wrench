...
public final class ConfigurationTools {
  ...
  public static < C extends Configuration > Configuration.Inspector< C > support( C configuration ) {
    return ( ( ConfigurationInspector.SupportEnabled ) configuration ).$$support$$() ;
  }
